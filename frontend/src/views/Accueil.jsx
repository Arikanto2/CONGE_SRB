...
export default function Accueil() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-base-200">
      <h1 className="mb-4 text-2xl font-bold">Bienvenue, {nom ? nom : "Chargement..."}</h1>
            ...
            {dernieresDemandes.length > 0 ? (
              dernieresDemandes.map((demande, index) => (
                <li key={index}>
                  ...
                  <span
                    className={`text-${demande.VALIDCHEF === "En attente" ? "warning" : demande.VALIDCHEF === "Validé" ? "success" : "error"}`}
                  >
                    {demande.VALIDCHEF}
                  </span>
                </li>
